...
public class UserDetailsVO extends User {
	...
	public UserDetailsVO(String username, String password, boolean enabled,
			...
			String userNation, String phone, String zipCode, String address1, String address2, String city, String region, String country) {
	...
	public String getUserNation() { return userNation; }
	public void setUserNation(String userNation) { this.userNation = userNation; }
