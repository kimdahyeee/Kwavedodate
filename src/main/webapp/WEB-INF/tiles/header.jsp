...
<link href="resources/plugins/magnific-popup/magnific-popup.css"
	rel="stylesheet">
<link href="resources/plugins/rs-plugin/css/settings.css"
	rel="stylesheet">
<link href="resources/css/animations.css" rel="stylesheet">
<link href="resources/plugins/owl-carousel/owl.carousel.css"
	rel="stylesheet">
<link href="resources/plugins/owl-carousel/owl.transitions.css"
	rel="stylesheet">
<link href="resources/plugins/swiper/swiper.min.css" rel="stylesheet"
	type="text/css">
						...
						<div class="col-md-3">
							<div class="header-left clearfix">
								<div class="header-dropdown-buttons text-center visible-xs">
									<div
										class="btn-group dropdown hidden-lg hidden-md hidden-sm circle small">
								...
								<div id="logo" class="logo">
									<a href="/kwaveweb/"><img id="logo_img"
										src="resources/images/logo.png" alt="The Project"></a>
								</div>
							</div>
						</div>
										...
										<div class="container-fluid">
											...
											<div class="collapse navbar-collapse" id="navbar-collapse-1">
												<ul class="nav navbar-nav">
													...
													<li class="header-top-dropdown"><a href="#"
														class="dropdown-toggle language" data-toggle="dropdown">Language
