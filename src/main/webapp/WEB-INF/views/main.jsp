...
<html lang="ko">
	...
	<body class="no-trans transparent-header">
							...
							<div class="col-md-3">
								<div class="header-left clearfix">
									...
									<div id="logo" class="logo">
										<a href="main"><img id="logo_img" src="resources/images/logo.png" alt="The Project"></a>
									</div>
								</div>
							</div>
		...
		<script type="text/javascript" src="resources/js/template1.js"></script>
		<script type="text/javascript" src="resources/js/customs1.js"></script>
	</body>
</html>
